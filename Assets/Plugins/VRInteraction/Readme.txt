...
4. It can occur that your actions are not yet mapped to buttons on your controller, you can check this via "Window > Steam VR Input" clicking "Open bindung UI" and check your current bindings.

Please also make sure that SteamVR and Steam are started.