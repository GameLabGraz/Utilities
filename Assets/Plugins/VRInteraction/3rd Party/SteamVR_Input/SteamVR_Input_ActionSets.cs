...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_VRInteractionPlugin p_VRInteractionPlugin;
        ...
        public static SteamVR_Input_ActionSet_VRInteractionPlugin VRInteractionPlugin
        {
            get
            {
                return SteamVR_Actions.p_VRInteractionPlugin.GetCopy<SteamVR_Input_ActionSet_VRInteractionPlugin>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_VRInteractionPlugin = ((SteamVR_Input_ActionSet_VRInteractionPlugin)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_VRInteractionPlugin>("/actions/VRInteractionPlugin")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.VRInteractionPlugin};
        }
    }
}
